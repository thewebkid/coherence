<template>
  <div class="handbook-page fade-in">
      ...
      <div class="handbook-layout">
        ...
        <main class="handbook-content">
          <header class="handbook-header">
            ...
            <h1>Handbook of Practices</h1>
            <p class="handbook-subtitle">A practical guide on carrying coherence in our daily lives</p>
          </header>
          ...
          <!-- Download -->
          <div class="handbook-download">
            <DownloadButton
              href="/pdf/Handbook of Practices v1.4.pdf"
              label="Download Full Handbook (PDF)"
            />
          </div>
        </main>
      </div>
...
import { getHandbookSections } from '@/utils/content';

const route = useRoute();
const router = useRouter();

const sections = getHandbookSections();
...
useHead({
  title: computed(() => `${currentSection.value?.title || 'Handbook'} — Coherence Across Scales`),
  meta: [
